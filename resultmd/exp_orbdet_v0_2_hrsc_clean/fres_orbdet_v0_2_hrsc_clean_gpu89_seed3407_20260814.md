...
- 当前：正式训练已完成 103E。
- 非塌缩门：通过。
- 最佳：epoch 48，clean validation mAP `0.9029`，AP50 `0.9030`。
- held-out test：未运行。
...
| 36 | 0.8940 | 0.8940 | — | 稳定 |
| 48 | **0.9029** | **0.9030** | — | 最佳 checkpoint |
| 60 | 0.8069 | 0.8070 | — | 短暂回落 |
| 72 | 0.8944 | 0.8940 | — | 恢复 |
| 84 | 0.8935 | 0.8940 | — | 稳定 |
| 96 | 0.8928 | 0.8930 | — | 最后一次验证 |
...
seed 3407 已达到 90，但不能据此声称“每次稳定 90”。必须在相同合同下完成
