...
config="${repo_root}/configs/orbdet/orbdet_v0_2_r50_dota1_1x_gpu89.py"
work_dir=/data1/zcy/Orbdet/work_dirs/formal/orbdet_v0_2_dota1_1x_gpu89_seed3407_20260815
...
if [[ -n "${gpu_processes}" ]]; then
  rtk echo 'GPU 8/9 are not idle; refusing to start DOTA-v1 formal.' >&2
  exit 4
fi
